...
if __name__ == "__main__":
    model = Backbone_VSSM(depths = [2, 2, 15, 2],dims = [96, 192, 384, 768],norm_layer='ln',ssm_conv_bias=False,
                          mlp_ratio=4.0,patch_size=4,downsample_version='v3',forward_type="v4noz",ssm_d_state=1,patchembed_version='v2',
                          pretrained='/ssd1/zhuweiye/Multimodal-Mamba/pretrained_model/vision_encoder/vssm_small_0229_ckpt_epoch_222.pth'
                          )
